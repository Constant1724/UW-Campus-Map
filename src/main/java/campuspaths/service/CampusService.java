 ...
 *
 * <p>It adjust the following behavior to make it works better with web responses: findPath() now is
 * able to accept any strings as start and end buildings, for those invalid strings (Short name of
 * building is not in our data set) a ServerSideException will be thrown
 */
@Service
public class CampusService {
   ...
   * another list all buildings in the campus
   */
   ...
   * @spec.effects this.model : obtain an instance of CampusMapModel with Campus Path Data and
   *     Campus Building Data loaded.
   * @spec.effects this.shortToBuilding : create a mapping from building's short name to Building
   *     instance, for all buildings in the campus.
   */
