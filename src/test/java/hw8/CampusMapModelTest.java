...
public class CampusMapModelTest {
    ...
    public static String buildingsMalFormedFileName = "src/main/java/hw8/data/campus_buildings_malformed.tsv";
    ...
    /**
     * Test makeInstance is implemented properly. Specifically, testPathAllBuildings.test if buildings data and path data are loaded
     * correctly.
     */
    @Test
    ...
    /**
     * Test if IOException or DataMalformed Exception are correctly detected and rethrow as RuntimeException.
     */
