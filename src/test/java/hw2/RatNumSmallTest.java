...
/**
 * This class contains a <em>small</em> set of testPathAllBuildings.test cases that can be used to testPathAllBuildings.test the
 * implementation of the RatNum class. For a more complete testPathAllBuildings.test, see <tt>RatNumTest</tt>. This
 * class, <tt>RatNumSmallTest</tt>, deliberately omits some of the tests from <tt>RatNumTest</tt>,
 * to permit comparing the effects of the two testPathAllBuildings.test suites.
 */
