...
public class CampusMapModelTest {
  ...
  public static String buildingsFileName = "src/main/java/UI/data/campus_buildings_test.tsv";
  public static String buildingsMalFormedFileName =
      "src/main/java/UI/data/campus_buildings_malformed.tsv";
  public static String pathsFileName = "src/main/java/UI/data/campus_paths_test.tsv";
  public static String pathsMalFormedFileName = "src/main/java/UI/data/campus_paths_malformed.tsv";
