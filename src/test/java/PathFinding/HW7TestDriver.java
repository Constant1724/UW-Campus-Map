...
public class HW7TestDriver {
  ...
  protected static void printUsage() {
    ...
    System.err.println("to read from a file: java PathFinding.test.HW7TestDriver <name of input script>");
    System.err.println("to read from standard in: java PathFinding.test.HW7TestDriver");
  }
  ...
  private static String path = "src/main/java/PathFinding/data/";
