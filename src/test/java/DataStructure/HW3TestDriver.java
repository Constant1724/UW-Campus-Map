...
public class HW3TestDriver {
  ...
  protected static void printUsage() {
    ...
    System.err.println("to read from a file: java DataStructure.test.HW3TestDriver <name of input script>");
    System.err.println("to read from standard in: java DataStructure.test.HW3TestDriver");
  }
